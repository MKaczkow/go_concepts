...
import (
	...
	computev1alpha1 "github.com/mkaczkow/go_concepts/api/v1alpha1"
)
...
// +kubebuilder:rbac:groups=compute.some.domain,resources=ec2instances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.some.domain,resources=ec2instances/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=compute.some.domain,resources=ec2instances/finalizers,verbs=update
