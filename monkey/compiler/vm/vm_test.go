...
// I guess that’s what great tooling and infrastructure does for you:
// reduce the cost of adding new tests and, thus, features.
...
func testExpectedObject(
	...
	case *object.Error:
		errObj, ok := actual.(*object.Error) // Once more - type assertion
		if !ok {
